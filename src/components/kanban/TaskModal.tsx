        ...
        {editingTaskId && task && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-app-bg/60 backdrop-blur-sm">
            <motion.div
              ...
              className="glass-panel shadow-2xl rounded-3xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh] border border-app-border-light"
            >
              <div className="flex justify-between items-center p-6 border-b border-app-border-light">
                <h2 className="text-2xl font-bold text-app-text">Detalhes da Meta</h2>
                <button onClick={() => setEditingTaskId(null)} className="text-app-text-muted hover:text-app-text-secondary cursor-pointer"><X size={24} /></button>
              </div>
              ...
              <div className="p-6 border-t border-app-border-light bg-app-surface flex justify-between items-center">
